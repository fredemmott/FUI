...
NavigationView::NavigationView(const id_type id)
  : Widget(id, NavigationViewStyleClass, {}),
    mPane(
  ...
  mPane->SetChildren({mPaneHeader, mItemsRoot, mFooterItemsRoot});
  mContentOuter->SetChildren({mContentHeader, mContentInner});
  this->SetChildren({mPane, mContentOuter});
}
